  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-card text-card-foreground border-r border-border">
      ...
      <div className="p-3 sm:p-4 border-t border-border mt-auto">
        <div className="bg-primary/5 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 text-center">
            {qrValue ? (
              ...
              <div className="h-[72px] w-[72px] mx-auto bg-muted rounded mb-2" />
            )}
        ...
        <Button 
          variant="ghost" 
          className="w-full justify-start text-muted-foreground hover:text-destructive hover:bg-destructive/10 pl-3 sm:pl-4 min-h-[44px]"
          onClick={logout}
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <div className="lg:hidden">
        ...
        <main className="bg-muted/20 min-h-[calc(100vh-52px)] pb-20">
