                ...
                <div className="p-6 flex flex-col items-center">
                  ...
                  <Calendar
                    ...
                    classNames={{
                      ...
                      nav_button: "h-8 w-8 bg-transparent p-0 opacity-60 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-input hover:bg-accent absolute top-1",
